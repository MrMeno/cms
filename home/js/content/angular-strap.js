...
(function(window, document, undefined) {
  ...
  angular.module('mgcrea.ngStrap.tooltip', [ 'mgcrea.ngStrap.core', 'mgcrea.ngStrap.helpers.dimensions' ]).provider('$tooltip', function() {
    var defaults = this.defaults = {
      ...
      target: false,
      placement: 'top',
      templateUrl: '../js/angular-strap/angular-strap-master/src/tooltip/tooltip.tpl.html',
      template: '',
      titleTemplate: false,
      trigger: 'hover focus',
      keyboard: false,
  ...
  angular.module('mgcrea.ngStrap.popover', [ 'mgcrea.ngStrap.tooltip' ]).provider('$popover', function() {
    var defaults = this.defaults = {
      ...
      target: false,
      placement: 'bottom',
      templateUrl: '../js/angular-strap/angular-strap-master/src/popover/popover.tpl.html',
